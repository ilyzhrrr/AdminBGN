    ...
    <div className="flex min-h-screen bg-[#D1E9FF] font-sans">
      ...
      <main className="flex-1 p-4 sm:p-6 lg:p-8 pt-16 lg:pt-8 overflow-y-auto min-w-0">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-2xl sm:text-3xl font-black text-gray-900 mb-6 sm:mb-8">Pengaturan</h1>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-3xl shadow-sm p-5 sm:p-8 text-gray-800">
